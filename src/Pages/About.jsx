  ...
  return (
    <div className="about-page">
      ...
      <main className="about-main">
        ...
        <section id="contact" className="section section--mist">
          <div className="container">
            <div className="grid two">
              <div className="availability">
                <h2 className="section__title">Availability</h2>
                <div className="availability__content">
                  <p className="availability__notice">
                    <strong>Available in Hasselt, Belgium</strong> during February 2026.
                  </p>
                  <p>
                    Open to collaborations, performances, residencies, and creative exchanges 
                    throughout Europe. Specializing in immersive live sets and studio collaborations.
                  </p>
                  
                  <div className="platforms-section">
                    <h3 className="mini-title">Connect</h3>
                    <ul className="platforms">
                      <li className="platform">
                        <span className="platform__name">SoundCloud</span>
                        <a
                          href="https://soundcloud.com/flaneur23"
                          target="_blank"
                          rel="noopener noreferrer"
                      ...
                      <li className="platform">
                        <span className="platform__name">LEVEL MUSIC</span>
                        <span className="platform__value">Collective</span>
                      </li>
                      <li className="platform">
                        <span className="platform__name">X (Twitter)</span>
                        <span className="platform__value">@SensuRerum</span>
                      </li>
                    </ul>
                  </div>
                </div>
                ...
                <div className="contact__content">
                  <div className="contact__identity">
                    <p className="contact__name">
                      <strong>Esteban Quintero</strong>
                    </p>
                    <p className="contact__alias">Flâneur</p>
                  </div>
                  ...
                  <div className="contact__details">
                    <div className="contact__item">
                      ...
                      <div className="contact__info">
                        ...
                        <span className="contact__value">[your email here]</span>
                      </div>
                    </div>
                    <div className="contact__item">
                      <span className="contact__icon">📞</span>
                      <div className="contact__info">
                        ...
                        <span className="contact__value">[your phone number]</span>
                      </div>
                    </div>
                    <div className="contact__item">
                      <span className="contact__icon">🎛️</span>
                      <div className="contact__info">
                        <span className="contact__label">Collective</span>
                        <span className="contact__value"><strong>LEVEL MUSIC</strong></span>
                      </div>
                    </div>
                  </div>

                  <p className="contact__note">
                    For press or booking inquiries, please include <strong>"EPK – Flâneur"</strong> in the subject line.
                  </p>
                </div>
              </div>
            </div>
